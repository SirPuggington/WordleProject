...
Getestet über:
* http://localhost/wordlemania/

XAMPP-Version:
* XAMPP for Windows 8.1.6-0
...
* Die Webseite ändert das favicon je nach dem ob es sich um eine Art von Infoseite handelt oder nicht. Das ist Absicht.
